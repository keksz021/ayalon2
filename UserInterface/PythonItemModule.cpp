...
static PyObject *itemGetApplyPoint(PyObject *poSelf, PyObject *poArgs)
{
	int applyType = 0;
...
PyObject* itemGetApply(PyObject* poSelf, PyObject* poArgs)
{
	int applyType = 0;
	if (!PyTuple_GetInteger(poArgs, 0, &applyType))
		return Py_BadArgument();

	return Py_BuildValue("i", PointTypeToApplyType((BYTE)applyType));
}
#endif
...
void initItem()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetApply",						itemGetApply,							METH_VARARGS },
...
//	PyModule_AddIntConstant(poModule, "EQUIPMENT_PENDANT", c_Equipment_Pendant);
	...
	PyModule_AddIntConstant(poModule, "EQUIPMENT_PENDANT_FIRE", c_EquipmentPendantFire);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_PENDANT_ICE", c_EquipmentPendantIce);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_PENDANT_THUNDER", c_EquipmentPendantThunder);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_PENDANT_WIND", c_EquipmentPendantWind);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_PENDANT_DARK", c_EquipmentPendantDark);
	PyModule_AddIntConstant(poModule, "EQUIPMENT_PENDANT_EARTH", c_EquipmentPendantEarth);
	...
	PyModule_AddIntConstant(poModule, "WEARABLE_PENDANT_FIRE", CItemData::WEARABLE_PENDANT_FIRE);
	PyModule_AddIntConstant(poModule, "WEARABLE_PENDANT_ICE", CItemData::WEARABLE_PENDANT_ICE);
	PyModule_AddIntConstant(poModule, "WEARABLE_PENDANT_THUNDER", CItemData::WEARABLE_PENDANT_THUNDER);
	PyModule_AddIntConstant(poModule, "WEARABLE_PENDANT_WIND", CItemData::WEARABLE_PENDANT_WIND);
	PyModule_AddIntConstant(poModule, "WEARABLE_PENDANT_EARTH", CItemData::WEARABLE_PENDANT_EARTH);
	PyModule_AddIntConstant(poModule, "WEARABLE_PENDANT_DARK", CItemData::WEARABLE_PENDANT_DARK);
#endif
...
/*	PyModule_AddIntConstant(poModule, "ARMOR_PENDANT_FIRE", CItemData::ARMOR_PENDANT_FIRE);
	PyModule_AddIntConstant(poModule, "ARMOR_PENDANT_ICE", CItemData::ARMOR_PENDANT_ICE);
	PyModule_AddIntConstant(poModule, "ARMOR_PENDANT_THUNDER", CItemData::ARMOR_PENDANT_THUNDER);
	PyModule_AddIntConstant(poModule, "ARMOR_PENDANT_WIND", CItemData::ARMOR_PENDANT_WIND);
	PyModule_AddIntConstant(poModule, "ARMOR_PENDANT_EARTH", CItemData::ARMOR_PENDANT_EARTH);
	PyModule_AddIntConstant(poModule, "ARMOR_PENDANT_DARK", CItemData::ARMOR_PENDANT_DARK);*/
#endif
