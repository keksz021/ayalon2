...
#endif
	PyModule_AddIntConstant(poModule, "EVENT_TYPE_AYALON_LADA", InGameEventManager::EVENT_TYPE_AYALON_LADA);
	PyModule_AddIntConstant(poModule, "EVENT_TYPE_SZERENCSE", InGameEventManager::EVENT_TYPE_SZERENCSE);
