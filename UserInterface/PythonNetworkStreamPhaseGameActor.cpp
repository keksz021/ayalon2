...
bool CPythonNetworkStream::RecvCharacterAppendPacket()
{
	...
	kNetActorData.m_dwAchievementTitle = 0;
#endif
#ifdef ENABLE_MULTI_LANGUAGE_SYSTEM
...
#endif
#ifdef ENABLE_ACHIEVEMENT_SYSTEM
		kNetActorData.m_dwAchievementTitle = chrInfoPacket.dwAchievementTitle;
#endif
#ifdef ENABLE_MULTI_LANGUAGE_SYSTEM
...
bool CPythonNetworkStream::RecvCharacterUpdatePacket()
{
	...
	kNetUpdateActorData.m_dwLevel = chrUpdatePacket.dwLevel;	//level fix
...
#endif
#ifdef ENABLE_ACHIEVEMENT_SYSTEM
	kNetUpdateActorData.m_dwAchievementTitle = chrUpdatePacket.dwAchievementTitle;
#endif
#ifdef ENABLE_MULTI_LANGUAGE_SYSTEM
