...
typedef struct SShopItemTable
{
	...
	SShopItemTable() : price_type(SHOPEX_GOLD), 
		price_vnum(0), price_vnum2(0), price2(0),
		price3(0), price_vnum3(0)
	{
...
#ifdef ENABLE_ACHIEVEMENT_SYSTEM
	SHOP_SUBHEADER_GC_NOT_ENOUG_ACHIEVEMENT,
#endif
#endif
