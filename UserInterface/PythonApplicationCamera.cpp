...
void CPythonApplication::__UpdateCamera()
{
	...
	else if (CAMERA_MODE_FREE == m_iCameraMode)
	{
		...
		SetCenterPosition(m_kEventCameraSetting.v3CenterPosition.x,
			-m_kEventCameraSetting.v3CenterPosition.y,
			m_kEventCameraSetting.v3CenterPosition.z);

		SetGlobalCenterPosition(
			long(m_kEventCameraSetting.v3CenterPosition.x / 100.0f),
			long(-m_kEventCameraSetting.v3CenterPosition.y / 100.0f));
	}
#endif
