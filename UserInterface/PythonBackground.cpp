...
bool CPythonBackground::SetShadowLevel(int eLevel)
{
	...
	case SHADOW_NONE:
		...
		rkMap.SetShadowTextureSize(512 * SHADOW_TEXTURE_MULTIPLIER);
		break;
	...
	case SHADOW_ALL_HIGH:
		rkMap.SetDrawShadow(true);
		rkMap.SetDrawCharacterShadow(true);
		rkMap.SetShadowTextureSize(1024 * SHADOW_TEXTURE_MULTIPLIER);
		break;

	case SHADOW_ALL_MAX:
		rkMap.SetDrawShadow(true);
		rkMap.SetDrawCharacterShadow(true);
		rkMap.SetShadowTextureSize(2048 * SHADOW_TEXTURE_MULTIPLIER);
		break;
	}
