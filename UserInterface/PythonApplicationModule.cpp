...
static PyObject* appGetFreeCameraCenter(PyObject*, PyObject*)
{
#ifdef FREE_MOVE_CAM_ADALET
	const CPythonApplication::SCameraSetting& st = CPythonApplication::Instance().GetEventCameraSetting();
	return Py_BuildValue("fff", st.v3CenterPosition.x, st.v3CenterPosition.y, st.v3CenterPosition.z);
#else
...
void initapp()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetFreeCameraCenter", appGetFreeCameraCenter, METH_VARARGS },
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_PLUS_LEVEL_ICON", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ITEM_PLUS_LEVEL_ICON", 0);
#endif
...
#ifdef ENABLE_INTROSELECT_EFFECTS
	PyModule_AddIntConstant(poModule, "ENABLE_INTROSELECT_EFFECTS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_INTROSELECT_EFFECTS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_ALIGNMENT_BONUS", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ALIGNMENT_BONUS", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_METIN_QUEUE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_METIN_QUEUE", 0);
#endif

#ifdef ENABLE_GUILD_BONUSES
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_BONUSES", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_BONUSES", 0);
#endif
#ifdef FREE_MOVE_CAM_ADALET
	PyModule_AddIntConstant(poModule, "FREE_MOVE_CAM_ADALET", 1);
#else
	PyModule_AddIntConstant(poModule, "FREE_MOVE_CAM_ADALET", 0);
#endif
