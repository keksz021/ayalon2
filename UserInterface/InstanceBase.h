...
public:
	...
	enum
	{
		...
		AFFECT_METIN_QUEUE, // 45
#endif
#ifdef ENABLE_BUFF_SYSTEM
		AFFECT_HOSIN_ITEM, // 42 (values may differ)
		AFFECT_BOHO_ITEM,
		AFFECT_GICHEON_ITEM,
		AFFECT_KWAESOK_ITEM,
		AFFECT_JEUNGRYEOK_ITEM, // 46
#endif
		AFFECT_NUM = 64,
	...
	enum
	{
		...
		NEW_AFFECT_ALIGNMENT_BONUS = 543,
#endif
#ifdef ENABLE_METIN_QUEUE
		NEW_AFFECT_METIN_QUEUE = 553,
#endif
#ifdef ENABLE_GUILD_BONUSES
		NEW_AFFECT_GUILD_BONUS_1 = 801,
		NEW_AFFECT_GUILD_BONUS_2 = 802,
		NEW_AFFECT_GUILD_BONUS_3 = 803,
		NEW_AFFECT_GUILD_BONUS_4 = 804,
		NEW_AFFECT_GUILD_BONUS_5 = 805,
		NEW_AFFECT_GUILD_BONUS_6 = 806,
		NEW_AFFECT_GUILD_BONUS_7 = 807,
		NEW_AFFECT_GUILD_BONUS_8 = 808,
#endif
...
protected:
	...
	DWORD	__AttachEffectToArmours(std::string effectfilename);
...
#endif
	void SetLevel(DWORD level); //level fix
...
#ifdef ENABLE_ACHIEVEMENT_SYSTEM
public:
	void SetAchievementTitle(uint32_t title) { m_dwAchievementTitle = title; }
	uint32_t GetAchievementTitle() const { return m_dwAchievementTitle; }
...
#ifdef ENABLE_METIN_QUEUE
public:
	void SetMetinQueueEffect(bool clear = false);
#endif
};
