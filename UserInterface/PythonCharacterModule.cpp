...
PyObject *chrCreateInstance(PyObject *poSelf, PyObject *poArgs)
{
	...
	if (PyTuple_Size(poArgs)==2)
	{
		...
		kCreateData.m_dwAchievementTitle = 0;
#endif
...
PyObject* chrGetNameRealByVID(PyObject* poSelf, PyObject* poArgs)
{
	int iVirtualID;
	if (!PyTuple_GetInteger(poArgs, 0, &iVirtualID))
		return Py_BuildException();
...
void initchr()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetNameRealByVID",                chrGetNameRealByVID,                METH_VARARGS },
...
#endif
#ifdef ENABLE_GUILD_BONUSES
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_GUILD_BONUS_1", CInstanceBase::NEW_AFFECT_GUILD_BONUS_1);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_GUILD_BONUS_2", CInstanceBase::NEW_AFFECT_GUILD_BONUS_2);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_GUILD_BONUS_3", CInstanceBase::NEW_AFFECT_GUILD_BONUS_3);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_GUILD_BONUS_4", CInstanceBase::NEW_AFFECT_GUILD_BONUS_4);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_GUILD_BONUS_5", CInstanceBase::NEW_AFFECT_GUILD_BONUS_5);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_GUILD_BONUS_6", CInstanceBase::NEW_AFFECT_GUILD_BONUS_6);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_GUILD_BONUS_7", CInstanceBase::NEW_AFFECT_GUILD_BONUS_7);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_GUILD_BONUS_8", CInstanceBase::NEW_AFFECT_GUILD_BONUS_8);
#endif
#ifdef ENABLE_ALIGNMENT_BONUS
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_ALIGNMENT_BONUS", CInstanceBase::NEW_AFFECT_ALIGNMENT_BONUS);
#endif
#ifdef ENABLE_BUFF_SYSTEM
	PyModule_AddIntConstant(poModule, "AFFECT_HOSIN_ITEM", CInstanceBase::AFFECT_HOSIN_ITEM);
	PyModule_AddIntConstant(poModule, "AFFECT_BOHO_ITEM", CInstanceBase::AFFECT_BOHO_ITEM);
	PyModule_AddIntConstant(poModule, "AFFECT_GICHEON_ITEM", CInstanceBase::AFFECT_GICHEON_ITEM);
	PyModule_AddIntConstant(poModule, "AFFECT_JEUNGRYEOK_ITEM", CInstanceBase::AFFECT_JEUNGRYEOK_ITEM);
	PyModule_AddIntConstant(poModule, "AFFECT_KWAESOK_ITEM", CInstanceBase::AFFECT_KWAESOK_ITEM);
#endif
}
